...
## Classical Programming vs Machine Learning  {auto-animate="true"}
...
::: r-stack
![](images/DLiR/classical-programming.png){width=400px}
![](images/DLiR/machine-learning.png){width=400px}
:::
...
::: {data-id="box1" style="background: #2780e3; width: 200px; height: 200px; border-radius: 200px; display: flex; align-items: top; justify-content: center; color: white; font-size: 0.5em;"}
AI
:::

::: {data-id="box2" style="background: #3fb618; width: 130px; height: 130px; border-radius: 200px; display: flex; align-items: top; justify-content: center; color: white; font-size: 0.5em;"}
ML
:::

::: {data-id="box3" style="background: #e83e8c; width: 60px; height: 60px; border-radius: 200px; display: flex; align-items: top; justify-content: center; color: white; font-size: 0.5em;"}
DL
:::
:::
...
::: r-stack
![](images/DLiR/nn-1.png){.fragment width="450" height="300"}

![](images/DLiR/nn-2.png){.fragment width="450" height="300"}

![](images/DLiR/nn-3.png){.fragment width="450" height="300"}

![](images/DLiR/nn-4.png){.fragment width="450" height="300"}
:::
